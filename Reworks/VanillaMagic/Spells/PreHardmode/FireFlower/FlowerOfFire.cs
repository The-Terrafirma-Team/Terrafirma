...
namespace Terrafirma.Reworks.VanillaMagic.Spells.PreHardmode.FireFlower
{
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < PetalAmount; i++)
            {
                Main.EntitySpriteDraw(Tex,
                    ...
                    i * (MathHelper.TwoPi / PetalAmount) + (float)(Main.timeForVisualEffects / 50f) + MathHelper.TwoPi / (PetalAmount * 2f),
            ...
            for (int i = 0; i < PetalAmount; i++)
            {
                Main.EntitySpriteDraw(Tex,
                    ...
                    new Rectangle(0, 0, 18, 26),
                    new Color(1f, 1f, 1f, 0f) * Projectile.Opacity,
                    i * (MathHelper.TwoPi / PetalAmount) + (float)(Main.timeForVisualEffects / 50f),
