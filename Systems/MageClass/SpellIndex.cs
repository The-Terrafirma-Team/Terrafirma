...
namespace TerrafirmaRedux.Systems.MageClass
{
    ...
    public class SpellIndex : ModSystem
    {
        ...
        public override void OnModLoad()
        {
            ...
            //TEST
            ItemCatalogue.Add(ItemID.WandofFrosting, new[] { 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2 });
            ...
            //Emerald Staff
            SpellCatalogue.Add(4, new Tuple<byte, string, string, string, string>(4, AssetPath + "Pre-Hardmode/GemStaff/AmethystBolt", "Emerald Bolt", "Shoots a Bolt of Mana", "Uses 6 Mana"));
            SpellCatalogue.Add(5, new Tuple<byte, string, string, string, string>(5, AssetPath + "Pre-Hardmode/GemStaff/AmethystHomingShot", "Homing Amethyst Bolt", "Shoots a Bolt of Homing Mana", "Uses 6 Mana"));
            //Ruby Staff
            SpellCatalogue.Add(6, new Tuple<byte, string, string, string, string>(6, AssetPath + "Pre-Hardmode/GemStaff/AmethystBolt", "Ruby Bolt", "Shoots a Bolt of Mana", "Uses 7 Mana"));
            SpellCatalogue.Add(7, new Tuple<byte, string, string, string, string>(7, AssetPath + "Pre-Hardmode/GemStaff/AmethystHomingShot", "Homing Amethyst Bolt", "Shoots a Bolt of Homing Mana", "Uses 6 Mana"));
            //Diamond Staff
            ...
            //Sapphire Staff
            SpellCatalogue.Add(10, new Tuple<byte, string, string, string, string>(10, AssetPath + "Pre-Hardmode/GemStaff/AmethystBolt", "Sapphire Bolt", "Shoots a Bolt of Mana", "Uses 6 Mana"));
            SpellCatalogue.Add(11, new Tuple<byte, string, string, string, string>(11, AssetPath + "Pre-Hardmode/GemStaff/AmethystHomingShot", "Homing Amethyst Bolt", "Shoots a Bolt of Homing Mana", "Uses 6 Mana"));
            //Amber Staff
