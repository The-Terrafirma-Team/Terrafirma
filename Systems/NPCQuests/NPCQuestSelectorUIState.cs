...
//                    QuestDialoguePanel.Height.Pixels = ((ButtonQuests[i].GetQuestDialogue().Length / 45) + 1) * 20f + 20f;
...
//                    QuestDialogue = new UIText(ButtonQuests[i].GetQuestDialogue(), 1f);
...
//                    QuestTaskPanel.Height.Pixels = ((ButtonQuests[i].GetQuestDescription().Length / 45) + 1) * 20f + 20f;
...
//                    QuestTask = new UIText(ButtonQuests[i].GetQuestDescription(), 1f);
//                    QuestTask.VAlign = 0f;
//                    QuestTask.HAlign = 0f;
