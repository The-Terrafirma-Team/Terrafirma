...
namespace TerrafirmaRedux.Particles
{
    public class HiResFlame : Particle
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(tex, Position - Main.screenPosition, new Rectangle(0, Frame * tex.Width, tex.Width, tex.Width), Color.Lerp(new Color(0.4f,1f,1f,0),Color,ai1), Rotation, tex.Size() / new Vector2(2, 8), Scale * ai1 * ai3, effect, 0);
