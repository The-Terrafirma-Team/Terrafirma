...
{
    public class ShadowBoxersParry : MeleeParry
    {
        ...
        public override void OnParryProjectile(Projectile p, Player player)
        {
            ...
            player.AddBuff(ModContent.BuffType<Buffs.Buffs.Parry.ShadowBoxersParry>(),(int)(60 * 4 * player.PlayerStats().ParryBuffDurationMultiplier));
        }
